...
class TerminalTicket extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('fee, shipping, datetime', 'required'),
			array('fee, shipping, age, created_by', 'numerical', 'integerOnly'=>true),
			array('price_paid', 'length', 'max'=>20),
			array('barcode, batch_no, first_name, last_name, voyage_no, ticket_no', 'length', 'max'=>100),
	...
	public function search()
	{
		...
		$criteria->compare('price_paid',$this->batch_no,true);
