...
{
$dataProvider=new CActiveDataProvider('PassengerType');
...
{
$model=new PassengerType('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['PassengerType']))
$model->attributes=$_GET['PassengerType'];
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='passenger-type-form')
{
